...
if __name__ == "__main__":
    ...
    # one word. The answer is 55
    input_csv = "input_1.csv"
    ouput_csv = "output_1.csv"
    clean_csv = "clean_1.csv"
    generate_input_file_1(1000, "one word. The answer is 55", input_csv)
    ...
    with open('result.txt', 'a') as file:
        file.write("\n")
        file.write("input_1.csv, output_1.csv, clean_1.csv; one word. The answer is 55; 1000 iterations\n")
